...
#ifndef NCOL_MOLECULAR_SAMPLE_H_INCLUDED
#define NCOL_MOLECULAR_SAMPLE_H_INCLUDED
...
class Ncol_molecular_sample : public Sample_point
{
public:

  ~Ncol_molecular_sample()
  {}
...
private:
  ...
  Ncol_molecular_system * parent;

};



#endif //NCOL_MOLECULAR_SAMPLE_H_INCLUDED
//-------------------------------------------------------------------------
