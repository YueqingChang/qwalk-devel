...
#ifndef NCOL_MOLECULAR_SYSTEM_H_INCLUDED
#define NCOL_MOLECULAR_SYSTEM_H_INCLUDED
#include "System.h"
#include "Pseudopotential.h"
#include "Particle_set.h"
#include "Pbc_enforcer.h"

class Ncol_molecular_system:public System
{
public:
  ...
  virtual void makeCopy(System *& ptr) {
    ptr=new Ncol_molecular_system(*this);
  }
  Ncol_molecular_system() {};

  Ncol_molecular_system(Ncol_molecular_system & sys) {
    ions=sys.ions;
...
private:
  friend class Ncol_molecular_sample;
  Particle_set ions;
  Array1 <int> nspin;
