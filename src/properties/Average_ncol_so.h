 ...
 */
#ifndef AVERAGE_NCOL_SO_H_INCLUDED
#define AVERAGE_NCOL_SO_H_INCLUDED
#include "Average_generator.h"
#include "Pseudopotential_so.h"
#include <iostream>
using namespace std; 
class Average_ncol_so:public Average_generator { 
 public:
...
//		System * sys, Pseudopotential *psp, Sample_point * sample, Properties_point & pt, Average_return & );
 ...
 private:
   ...
   Array1 <doublevar> spin_dir_theta;
